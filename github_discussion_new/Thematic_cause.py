...
class main:
    def __init__(self, project_description):
        ...
        self.bot_1 = open("github_discussion_new/T-cause.txt", "r").read()
        
        self.project_descrption = f"Identify casue from {project_description}" # WRITE ANY PROJECT DESCRIPTION HERE
