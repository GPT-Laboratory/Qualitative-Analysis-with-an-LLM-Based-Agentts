...
class main:
    def __init__(self,project_description):
        ...
        self.bot_1 = open("github_discussion_new/T-solution.txt", "r").read()

        
        self.project_descrption = f"Identify solution from {project_description}" # WRITE ANY PROJECT DESCRIPTION HERE
