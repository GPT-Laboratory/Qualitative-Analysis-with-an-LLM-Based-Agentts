...
class main:
    def __init__(self,project_description):
        ...
        self.bot_1 = open("github_discussion_new/C-pattern.txt", "r").read()
        
        self.project_descrption = f"Perform content analysis and identify pattern from {project_description}" # WRITE ANY PROJECT DESCRIPTION HERE
