...
class main:
    def __init__(self,project_description):
        ...
        self.bot_1 = open("github_discussion_new/D-pattern.txt", "r").read()

        
        self.project_descrption = f"Perform discourse analysis on {project_description}/12669" # WRITE ANY PROJECT DESCRIPTION HERE
