...
class main:
    def __init__(self,project_description):
        ...
        self.bot_1 = open("github_discussion_new/Narrative.txt", "r").read()

        
        self.project_descrption = f"Perform narrative analysis on {project_description}" # WRITE ANY PROJECT DESCRIPTION HERE
