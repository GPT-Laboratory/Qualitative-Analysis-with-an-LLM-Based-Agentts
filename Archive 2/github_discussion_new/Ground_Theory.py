...
class main:
    def __init__(self,project_description):
        ...
        self.bot_1 = open("github_discussion_new/G-opencoding.txt", "r").read()

        
        self.project_descrption = f"Perform ground theory on {project_description}/12669" # WRITE ANY PROJECT DESCRIPTION HERE
